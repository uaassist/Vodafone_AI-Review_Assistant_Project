...
**Крок 3: Побудуй історію, використовуючи ПРЯМУ МОВУ**
-   Починай з проблеми або мети ("Потрібна була допомога з...", "Заходив, щоб...").
-   Розкажи про рішення, використовуючи активні дієслова ("допомогли", "вирішили", "зробили").
...
*   **Приклад логіки:**
    ...
    *   **Правильний результат:** "Були технічні питання. Працівники допомогли все вирішити. Залишився задоволений."
