...
**2. Коли ти генеруєш фінальну чернетку відгуку:**
{
  ...
  "analysis": {
    ...
    "reasoning": "Коротке пояснення українською, чому ти обрав саме ці пункти на основі ієрарархії пріоритетів."
  },
...
exports.handler = async function (event) {
  ...
  try {
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        model: 'gpt-4-turbo',
        // --- ОСНОВНА ЗМІНА ТУТ: Повертаємо повну історію повідомлень ---
