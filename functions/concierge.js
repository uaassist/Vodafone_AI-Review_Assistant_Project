...
**2. Коли ти генеруєш фінальну чернетку відгуку:**
{
  ...
  "analysis": {
    ...
    "reasoning": "Коротке пояснення українською, чому ти обрав саме ці пункти на основі ієрарахії пріоритетів."
  },
  ...
  try {
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        // Ми передаємо системну інструкцію + ВСЮ історію повідомлень
        messages: [ 
